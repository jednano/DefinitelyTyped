...
interface SinonLanguageChains extends LanguageChains {
...
interface SinonNumericComparison extends NumericComparison {
...
interface SinonNumberComparer extends NumberComparer {
    (value: number, message?: string): SinonExpectShould;
}

interface SinonTypeComparison extends TypeComparison {
    (type: string, message?: string): SinonExpectShould;
    instanceof: SinonInstanceOf;
    instanceOf: SinonInstanceOf;
}

interface SinonInstanceOf extends InstanceOf {
    (constructor: Object, message?: string): SinonExpectShould;
}

interface SinonDeep extends Deep {
    equal: SinonEqual;
    property: SinonProperty;
}

interface SinonEqual extends Equal {
    (value: any, message?: string): SinonExpectShould;
}

interface SinonProperty extends Property {
    (name: string, value?: any, message?: string): SinonExpectShould;
}

interface SinonOwnProperty extends OwnProperty {
...
interface SinonInclude extends Include {
...
interface SinonKeys extends Keys {
    (...keys: string[]): SinonExpectShould;
    (keys: any[]): SinonExpectShould;
}

interface SinonMembers extends Members {
    (set: any[], message?: string): SinonExpectShould;
}

interface SinonThrow extends Throw {
    (): SinonExpectShould;
